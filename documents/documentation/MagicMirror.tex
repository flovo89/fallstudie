...
\end{figure}
Mit diesen beiden Geräten kann evaluiert werden, inwiefern der Google Assistant sinnvol verwendet werden kann im Magic Mirror. Punkte die untersucht werden während der Evaluation:
\begin{itemize}
